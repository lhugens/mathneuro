...
Deafult values of the HH model. Let us verify that the cell achieves its
resting potential
...
The system attains a steady state at ![\$(V,n,m,h) \\approx (-65.0mV,
0.3, 0.053, 0.60)\$](driver_eq11151904159742296452.png). Let us estimate
the proportion of open Na channels, and open K channels
...
``` {.codeoutput}
At rest, the proportion of open Na channels is 8.845130e-05
...
``` {.codeinput}
%IAppFun = @(t) 2.*( t >= 16 & t <= 18);
IAppFun = @(t) heaviside(16)-heaviside(18);
[t,U] = ode45(hh,tspan,u0);
...
R2020b](https://www.mathworks.com/products/matlab/)\
:::
